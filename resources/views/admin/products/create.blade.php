          ...
          <div class="card p-3">
            ...
            <div class="card-body">
              <form method="post" action="{{route('products.store')}}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <input type="number" name="old_price" placeholder="Prix ancien" class="form-control">
                </div>
                <div class="form-group">
                  <input type="number" name="inStock" placeholder="Quantité en stock" class="form-control">
                </div>
                <div class="form-group">
